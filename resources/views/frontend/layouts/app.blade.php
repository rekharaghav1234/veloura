...
.custom-navbar {
    ...
    border-bottom: 1px solid #ead7cd !important;

    box-shadow: 0 2px 12px rgba(75, 52, 44, 0.08) !important;
...
.desktop-search-box {
    ...
    border: 1px solid #d9c8bf !important;
...
.desktop-right .logout-btn {
    border: none !important;

    background: #ead7cd !important;
    color: #4b342c !important;
...
.desktop-right .login-btn:hover,
.desktop-right .logout-btn:hover {
    background: #b76e79 !important;
    color: #ffffff !important;
}

.desktop-right .register-btn:hover,
.desktop-right .admin-btn:hover {
    background: #b76e79 !important;
}
...
@media (max-width: 991.98px) {
    ...
    .custom-navbar > .container > .d-flex.d-lg-none {
    ...
    .custom-navbar form.d-lg-none .input-group {
        width: 100% !important;
    ...
    .custom-navbar .mobile-user-dropdown {
        ...
        box-shadow: 0 8px 25px rgba(75, 52, 44, .15) !important;
    }


    .custom-navbar .mobile-user-dropdown .dropdown-item {
        color: #4b342c !important;
    ...
    .custom-navbar .mobile-user-dropdown .dropdown-item:hover {
        background: #f6eee8 !important;
        color: #b76e79 !important;
    }
}
...
.admin-sidebar-inner {
    ...
    box-shadow: 5px 0 20px rgba(75, 52, 44, 0.18);
}
...
.admin-sidebar-link.return-link {
    color: #F3D9D5 !important;
}

.admin-sidebar-link.return-link i {
    color: #D9A5AC;
}
...
.admin-sidebar-divider {
    border-color: rgba(246, 238, 232, 0.18);
    margin: 18px 0;
}
...
/* 
   ...
   but we keep both for safety. The wrapper now has overflow-x:auto. */
            ...
            .table-order {
                ...
                width: 100%;
                min-width: 1100px;
                /* forces horizontal scroll when viewport is smaller */
            }
...
========================================= */
        ...
        .best-selling .wishlist-btn.active svg {
        ...
        /* =========================================
   COMMON PRODUCT CARD
   Load Products + Best Selling + New Arrivals
========================================= */
        ...
        .product-card:hover {
            transform: translateY(-5px);
            box-shadow: 0 10px 25px rgba(75, 52, 44, 0.12);
        } */
...
========================================= */
        ...
        .product-card .product-img-fixed {
            width: 100%;
            height: 320px;
            object-fit: cover;
            display: block;
        ...
        .product-card:hover .product-img-fixed {
...
========================================= */
        ...
        /* =========================================
   BEST SELLING / NEW ARRIVAL LABEL
========================================= */

        .product-card .best-selling-count {
            display: inline-flex;
            align-items: center;
            gap: 5px;
        ...
        .product-card .best-selling-count i {
            color: #B76E79;
        }
...
================================ */
        @media (max-width: 576px) {
            ...
            #best-selling-section {
                /* Best Selling section ke andar content */
        ...
        /* =========================================
   VELOURA DESKTOP NAVBAR - ALIGNMENT FIX
========================================= */
...
.custom-navbar {
    ...
    background: #f6eee8 !important;
    border-bottom: 1px solid #ead7cd;
    box-shadow: 0 2px 10px rgba(75, 52, 44, 0.08);
}

/* MAIN DESKTOP ROW */
.custom-navbar .desktop-navbar {
    min-height: 78px;
    display: flex !important;
    align-items: center !important;
    width: 100%;
...
.custom-navbar .desktop-search-box {
    width: 100%;
    height: 40px;
    display: flex;
    align-items: stretch;
...
.custom-navbar .desktop-search-input {
    width: calc(100% - 42px);
    height: 40px;
...
.custom-navbar .desktop-search-input:focus {
    border-color: #B76E79;
}

.custom-navbar .desktop-search-input::placeholder {
    color: #888;
}

.custom-navbar .desktop-search-btn {
    width: 42px;
    height: 40px;
...
.custom-navbar .desktop-search-btn:hover {
    background: #4B342C;
    color: #fff;
}
...
.custom-navbar .desktop-menu .nav-item {
    margin: 0 !important;
    padding: 0 !important;
}
...
.custom-navbar .desktop-menu .nav-link.active {
    color: #B76E79 !important;
}

.custom-navbar .desktop-menu .nav-link i {
    font-size: 18px;
}
...
.custom-navbar .desktop-cart .badge {
    font-size: 9px;
    min-width: 17px;
    height: 17px;
...
.custom-navbar .admin-btn {
    background: #4B342C !important;
    color: #fff !important;
}

.custom-navbar .admin-btn:hover {
    background: #B76E79 !important;
}
...
.custom-navbar .logout-btn:hover {
    background: #DEC2B4 !important;
}


/* =========================================
   EXTRA ADMIN MENU HIDE
========================================= */

/* .custom-navbar .desktop-admin-menu,
...
@media (max-width: 991.98px) {
    ...
    .custom-navbar .mobile-icon:hover {
        color: #B76E79 !important;
    }
    ...
    .custom-navbar .mobile-user-dropdown {
        ...
        border-radius: 10px;
        box-shadow: 0 8px 25px rgba(75, 52, 44, .12);
        padding: 6px;
    }
...
.hero-banner .carousel-control-next-icon {
    width: 35px;
    height: 35px;
    background-color: rgba(75, 52, 44, 0.75);
    border-radius: 50%;
    background-size: 45%;
}
...
/* =========================
   DESKTOP ADMIN SIDEBAR BUTTON
========================= */

.custom-navbar .admin-sidebar-btn {
    display: inline-flex !important;
    align-items: center !important;
    justify-content: center !important;
    ...
    box-shadow: 0 3px 8px rgba(75, 52, 44, 0.15) !important;
}

.custom-navbar .admin-sidebar-btn i {
    font-size: 22px !important;
    color: #fff !important;
}

.custom-navbar .admin-sidebar-btn:hover {
    background: #B76E79 !important;
    color: #fff !important;
}
...
if (
    (desktopMenuBtn && desktopMenuBtn.contains(e.target)) ||
